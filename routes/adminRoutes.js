...
admin_route.get('/view-product-service', auth.isLogin, ServiceController.viewProductService);
...
admin_route.get('/add-products',auth.isLogin,ProductsController.loadPackage);
admin_route.post('/add-products',upload.any(),ProductsController.addProduct);
admin_route.get('/view-products',auth.isLogin,ProductsController.viewProducts);
admin_route.get('/edit-products', auth.isLogin,ProductsController.editProducts);
admin_route.post('/edit-products', upload.single('image'),ProductsController.UpdateProducts);
admin_route.post('/products-is-active/:id/toggle', ProductsController.activeStatus);
admin_route.get('/delete-products',auth.isLogin,ProductsController.deleteProducts);

// Package Gallery Images
admin_route.get('/view-products-gallery',auth.isLogin,ProductsController.viewGallery);
admin_route.get('/edit-products-image', auth.isLogin, ProductsController.editGallery);
admin_route.post('/edit-products-image',upload.single('image'),ProductsController.replaceImg);
admin_route.post('/view-products-gallery',upload.any(),ProductsController.addNewImage);
admin_route.get('/delete-products-image',auth.isLogin,ProductsController.deleteImage);
