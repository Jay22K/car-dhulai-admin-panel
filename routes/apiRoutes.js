...
api_route.post('/sign_up', apiController.NewSignUp);
api_route.post('/otp_verification', apiController.VerifyOTP);
...
api_route.post('/trending', apiController.GetTrendingPackages);
...
//Products API
api_route.post('/search_products', apiController.SearchProduct);


// Product's API
api_route.post('/home/products', apiController.GetAllProducts);
api_route.post('/products/details', apiController.GetProductDetails);
